...
import Img from '../assets/Number=7.svg';
import 'flowbite';
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600 h-16">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        <a href="https://amrtarek0012.github.io/amr-portfolio/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="p-3 rounded">
